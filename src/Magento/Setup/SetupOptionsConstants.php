...
class SetupOptionsConstants
{
    ...
    public const ADMIN_KEY_USER = 'admin-user';

    public const ADMIN_KEY_PASSWORD = 'admin-password';

    public const ADMIN_KEY_EMAIL = 'admin-email';
